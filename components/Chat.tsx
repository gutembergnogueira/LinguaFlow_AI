...
export const Chat: React.FC<ChatProps> = ({ messages, isLoading, isSpeaking, onSpeakMessage }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-2 no-scrollbar bg-gray-50">
      {messages.length === 0 ? (
